...
elseif ($_REQUEST['do'] == 'clear_cache')
{
    clear_all_files();
...
elseif ($_REQUEST['do'] == 'main')
{
    ...
    if(isset($_SESSION['shop_guide']) && $_SESSION['shop_guide'] === true)
    {
        ...
        ecs_header("Location: ./index.php?do=first\n");
    ...
    if (!is_writeable('../' . DATA_DIR . '/order_print.tpll'))
    {
...
//    $modules = read_modules('../includes/modules/shipping');
    ...
    $smarty->display('setting_first.tpl');
}
...
//            $modules = read_modules('../includes/modules/payment');
    ...
    $smarty->display('setting_second.tpl');
}
...
elseif ($_REQUEST['do'] == 'third')
{
    ...
    $smarty->display('setting_third.tpl');
}
...
//-- 检查订单
/*------------------------------------------------------ */
elseif ($_REQUEST['do'] == 'check_order')
{
...
//-- Totolist操作
/*------------------------------------------------------ */
elseif ($_REQUEST['do'] == 'save_todolist')
{
...
elseif ($_REQUEST['do'] == 'get_todolist')
{
