...
// $modules['02_cat_and_goods']['11_goods_trash']      = 'items.php?act=trash';        // 商品回收站
...
// $modules['02_cat_and_goods']['50_virtual_card_list']   = 'items.php?act=list&extension_code=virtual_card';
// $modules['02_cat_and_goods']['51_virtual_card_add']    = 'items.php?act=add&extension_code=virtual_card';
