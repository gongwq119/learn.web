...
class lib_session
{
    ...
    {
        $this->lib_session($db, $session_table, $session_data_table, $session_name, $session_id);
    }

    function lib_session(&$db, $session_table, $session_data_table, $session_name = 'ECS_ID', $session_id = '')
    {
